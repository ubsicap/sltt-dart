...
abstract class BaseEntityState
  ...
  BaseEntityState({
    ...
    required DateTime data_parentProp_changeAt_,
    required this.data_parentProp_cid_,
    required this.data_parentProp_changeBy_,
    DateTime? data_parentProp_cloudAt_,
       ...
       change_cloudAt = change_cloudAt?.toUtc(),
       ...
       data_rank_cloudAt_ = data_rank_cloudAt_?.toUtc(),
       data_deleted_changeAt_ = data_deleted_changeAt_?.toUtc(),
       data_deleted_cloudAt_ = data_deleted_cloudAt_?.toUtc(),
       data_parentId_changeAt_ = data_parentId_changeAt_.toUtc(),
       data_parentId_cloudAt_ = data_parentId_cloudAt_?.toUtc(),
       data_parentProp_changeAt_ = data_parentProp_changeAt_.toUtc(),
       data_parentProp_cloudAt_ = data_parentProp_cloudAt_?.toUtc();
