...
void registerChangeLogEntryFactoryGroup(
  SafeJsonSerializationFactoryGroup<BaseChangeLogEntry> group,
) {
...
T deserializeChangeLogEntrySafely<T extends HasUnknownField>({
  required T Function(Map<String, dynamic>) restore,
  ...
  try {
    return deserializeWithUnknownFieldData(restore, json2, baseToJson);
  } catch (e, st) {
    ...
    return deserializeWithUnknownFieldData(restore, recovery, baseToJson);
  }
}
