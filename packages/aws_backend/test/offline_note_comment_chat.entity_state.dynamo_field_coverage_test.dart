  ...
  group('offline - DynamoNoteCommentChatDataEntityState field coverage', () {
    test('verifies all expected fields with UTC DateTime conversion', () {
      ...
      final state = DynamoNoteCommentChatDataEntityState(
        ...
        data_videoId_dataSchemaRev_: 1,
        data_videoId_changeAt_: localDataChangeAt,
        data_videoId_cid_: 'cid-video',
        data_videoId_changeBy_: 'user1',
        data_videoId_cloudAt_: localCloudAt,
        data_dateMs: 1234,
      ...
      expectAllDateTimeFieldsUtc(
        ...
        expectedDataVideoIdChangeAt: localDataChangeAt,
        expectedDataVideoIdCloudAt: localCloudAt,
