...
part of 'portion_translation.entity_state.dynamo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DynamoPortionDataEntityState _$DynamoPortionDataEntityStateFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('DynamoPortionDataEntityState', json, ($checkedConvert) {
  final val = DynamoPortionDataEntityState(
...
Map<String, dynamic> _$DynamoPortionDataEntityStateToJson(
  DynamoPortionDataEntityState instance,
) => <String, dynamic>{
