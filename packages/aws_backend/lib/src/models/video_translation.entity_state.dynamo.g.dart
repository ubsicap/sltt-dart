...
part of 'video_translation.entity_state.dynamo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DynamoVideoDataEntityState _$DynamoVideoDataEntityStateFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('DynamoVideoDataEntityState', json, ($checkedConvert) {
  final val = DynamoVideoDataEntityState(
...
Map<String, dynamic> _$DynamoVideoDataEntityStateToJson(
  DynamoVideoDataEntityState instance,
) => <String, dynamic>{
