...
part of 'marker.entity_state.dynamo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DynamoMarkerDataEntityState _$DynamoMarkerDataEntityStateFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('DynamoMarkerDataEntityState', json, ($checkedConvert) {
  final val = DynamoMarkerDataEntityState(
...
Map<String, dynamic> _$DynamoMarkerDataEntityStateToJson(
  DynamoMarkerDataEntityState instance,
) => <String, dynamic>{
