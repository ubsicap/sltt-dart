...
part of 'dynamo_entity_state.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DynamoEntityState _$DynamoEntityStateFromJson(Map<String, dynamic> json) =>
    $checkedCreate('DynamoEntityState', json, ($checkedConvert) {
      final val = DynamoEntityState(
...
Map<String, dynamic> _$DynamoEntityStateToJson(
  DynamoEntityState instance,
) => <String, dynamic>{
