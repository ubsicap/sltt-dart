  ...
  group('_orig_ fields', () {
    test(
      ...
      () {
        ...
        final storedAtJson = DateTime.parse(
        ...
        expect(
          p.change_storedAt_orig_,
          equals(DateTime.parse('2024-01-01T11:00:00Z')),
        );
    ...
    test('IsarProjectState preserves non-empty _orig_ field values', () {
      ...
      final rawJson = {
        ...
        'schemaVersion': 1,
        'change_storedAt': storedAtJson,
        'change_storedAt_orig_': '2024-01-15T09:30:00Z',
      ...
      expect(p.change_storedAt, equals(DateTime.parse('2024-02-01T11:00:00Z')));
  ...
  group('getDataAndStateUpdatesOrOutdatedBys', () {
    test(
      ...
      () {
        ...
        final testEntityState = IsarProjectState.fromJson(updates.stateUpdates);
