...
void main() {
  group('SyncManager websocket subscribe status parsing', () {
    test('domain stats ack payload can be parsed by DomainStatsResponse', () {
      ...
      expect(parsed.isIncremental, isFalse);
    });

    test(
      'domain stats ack payload defaults isIncremental to false when absent',
      () {
        final payload = {
          'domainId': 'user/2026-0721-171722-672-05qv-nEg9-user',
          'domainType': 'user',
    ...
    test('domain stats ack payload can parse isIncremental true', () {
      final payload = {
        'domainId': 'user/2026-0721-171722-672-05qv-nEg9-user',
        'domainType': 'user',
        'isIncremental': true,
      ...
      final parsed = DomainStatsResponse.fromJson(payload);
      expect(parsed.isIncremental, isTrue);
    });
