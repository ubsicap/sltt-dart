...
void main() {
  ...
  group('put to and get from storage - IsarProjectState', () {
    test('stores and retrieves with all expected fields - IsarProjectState', () async {
      ...
      for (final kv in jsonBase.entries) {
        ...
        expect(
          ...
          reason:
              'Field ${kv.key} is not a known ProjectState field. Update the expected value checks and knownProjectStateFields accordingly.',
        );
        expect(
          kv.value,
