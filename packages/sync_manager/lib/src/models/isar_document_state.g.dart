...
void _isarDocumentStateSerialize(
  ...
  writer.writeLong(offsets[9], object.data_contentLength);
  ...
  writer.writeString(offsets[16], object.data_parentId);
  writer.writeDateTime(offsets[17], object.data_parentId_changeAt_);
  writer.writeString(offsets[18], object.data_parentId_changeBy_);
  writer.writeString(offsets[19], object.data_parentId_cid_);
  writer.writeDateTime(offsets[20], object.data_parentId_cloudAt_);
  writer.writeLong(offsets[21], object.data_parentId_dataSchemaRev_);
  writer.writeString(offsets[22], object.data_rank);
  writer.writeDateTime(offsets[23], object.data_rank_changeAt_);
  writer.writeString(offsets[24], object.data_rank_changeBy_);
  writer.writeString(offsets[25], object.data_rank_cid_);
  writer.writeDateTime(offsets[26], object.data_rank_cloudAt_);
  writer.writeLong(offsets[27], object.data_rank_dataSchemaRev_);
  writer.writeString(offsets[28], object.data_title);
  writer.writeDateTime(offsets[29], object.data_title_changeAt_);
  writer.writeString(offsets[30], object.data_title_cid_);
  writer.writeString(offsets[31], object.entityId);
  writer.writeString(offsets[32], object.entityType);
  writer.writeLong(offsets[33], object.schemaVersion);
  writer.writeString(offsets[34], object.unknownJson);
}
...
IsarDocumentState _isarDocumentStateDeserialize(
  ...
  final object = IsarDocumentState(
    ...
    data_contentLength: reader.readLongOrNull(offsets[9]),
    ...
    data_parentId: reader.readString(offsets[16]),
    data_parentId_changeAt_: reader.readDateTime(offsets[17]),
    data_parentId_changeBy_: reader.readString(offsets[18]),
    data_parentId_cid_: reader.readString(offsets[19]),
    data_parentId_cloudAt_: reader.readDateTimeOrNull(offsets[20]),
    data_parentId_dataSchemaRev_: reader.readLongOrNull(offsets[21]),
    data_rank: reader.readStringOrNull(offsets[22]),
    data_rank_changeAt_: reader.readDateTimeOrNull(offsets[23]),
    data_rank_changeBy_: reader.readStringOrNull(offsets[24]),
    data_rank_cid_: reader.readStringOrNull(offsets[25]),
    data_rank_cloudAt_: reader.readDateTimeOrNull(offsets[26]),
    data_rank_dataSchemaRev_: reader.readLongOrNull(offsets[27]),
    data_title: reader.readStringOrNull(offsets[28]),
    data_title_changeAt_: reader.readDateTimeOrNull(offsets[29]),
    data_title_cid_: reader.readStringOrNull(offsets[30]),
    entityId: reader.readString(offsets[31]),
    entityType: reader.readStringOrNull(offsets[32]) ?? 'document',
    schemaVersion: reader.readLongOrNull(offsets[33]),
  );
  object.id = id;
  object.unknownJson = reader.readString(offsets[34]);
  return object;
}
