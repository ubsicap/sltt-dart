...
extension IsarUserPreferencesDataEntityStateByIndex
  ...
  Future<IsarUserPreferencesDataEntityState?> getByEntityId(String entityId) {
    return getByIndex(r'entityId', [entityId]);
  }

  IsarUserPreferencesDataEntityState? getByEntityIdSync(String entityId) {
  ...
  Future<List<IsarUserPreferencesDataEntityState?>> getAllByEntityId(
  ...
  List<IsarUserPreferencesDataEntityState?> getAllByEntityIdSync(
    List<String> entityIdValues,
  ) {
    final values = entityIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByEntityId(IsarUserPreferencesDataEntityState object) {
