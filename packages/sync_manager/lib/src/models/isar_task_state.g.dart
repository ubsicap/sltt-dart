...
void _isarTaskStateSerialize(
  ...
  writer.writeString(offsets[18], object.data_nameLocal);
  writer.writeDateTime(offsets[19], object.data_nameLocal_changeAt_);
  writer.writeString(offsets[20], object.data_nameLocal_changeBy_);
  writer.writeString(offsets[21], object.data_nameLocal_cid_);
  writer.writeDateTime(offsets[22], object.data_nameLocal_cloudAt_);
  writer.writeLong(offsets[23], object.data_nameLocal_dataSchemaRev_);
  ...
  writer.writeString(offsets[46], object.stateDataHash);
  writer.writeString(offsets[47], object.stateDataHash_orig_);
  writer.writeString(offsets[48], object.unknownJson);
}
...
IsarTaskState _isarTaskStateDeserialize(
  ...
  final object = IsarTaskState(
    ...
    data_nameLocal: reader.readString(offsets[18]),
    data_nameLocal_changeAt_: reader.readDateTime(offsets[19]),
    data_nameLocal_changeBy_: reader.readString(offsets[20]),
    data_nameLocal_cid_: reader.readString(offsets[21]),
    data_nameLocal_cloudAt_: reader.readDateTimeOrNull(offsets[22]),
    data_nameLocal_dataSchemaRev_: reader.readLongOrNull(offsets[23]),
    ...
    entityType: reader.readStringOrNull(offsets[44]) ?? 'task',
    id: id,
...
extension IsarTaskStateByIndex on IsarCollection<IsarTaskState> {
  Future<IsarTaskState?> getByChange_domainIdEntityId(
  ...
  IsarTaskState? getByChange_domainIdEntityIdSync(
    String change_domainId,
    String entityId,
  ) {
  ...
  Future<List<IsarTaskState?>> getAllByChange_domainIdEntityId(
  ...
  List<IsarTaskState?> getAllByChange_domainIdEntityIdSync(
    List<String> change_domainIdValues,
    List<String> entityIdValues,
  ) {
    final len = change_domainIdValues.length;
  ...
  Future<Id> putByChange_domainIdEntityId(IsarTaskState object) {
  ...
  Future<IsarTaskState?> getByChange_domainIdData_parentIdEntityId(
    String change_domainId,
  ...
  IsarTaskState? getByChange_domainIdData_parentIdEntityIdSync(
    String change_domainId,
    String data_parentId,
    String entityId,
  ) {
  ...
  Future<List<IsarTaskState?>> getAllByChange_domainIdData_parentIdEntityId(
    List<String> change_domainIdValues,
  ...
  List<IsarTaskState?> getAllByChange_domainIdData_parentIdEntityIdSync(
    List<String> change_domainIdValues,
    List<String> data_parentIdValues,
    List<String> entityIdValues,
  ) {
  ...
  Future<Id> putByChange_domainIdData_parentIdEntityId(IsarTaskState object) {
